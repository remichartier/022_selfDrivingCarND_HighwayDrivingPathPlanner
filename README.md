...
### Simulator.
The Term3 Simulator which contains the Path Planning Project can be downloadable from the [releases tab (https://github.com/udacity/self-driving-car-sim/releases/tag/T3_v1.2).  
