 ...
 * v09 : Add MAX_ACCEL, MAX_SPEED_MPH, try to implement decision to move right as well
 *       Try to add fsm.cpp and fsm.h to introduce fsm_transition_function() usage
 */
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // Above replaced by fsm_transition_function
          bool too_close;
          fsm_transition_function(prev_size, car_s, end_path_s, too_close, 
                            sensor_fusion, lane);
